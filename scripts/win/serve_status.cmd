...
echo.
echo   Автоматический тест (раскомментируйте для включения):
REM curl -s http://127.0.0.1:8000/ >nul 2>&1
REM if %errorlevel% equ 0 (
REM     echo ✅ Сервер отвечает на главной странице
REM ) else (
REM     echo ❌ Сервер не отвечает
REM )
echo.
